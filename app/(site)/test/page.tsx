...
export default function HomePage() {
  ...
  // Lock logo position for test page
  useEffect(() => {
    setLogoState(0)
          ...
          <div className="flex items-start justify-start gap-8">
            ...
            >
              ...
              <div
                ...
                onMouseEnter={() => setIsContactExpandedDesktop(true)}
                onMouseLeave={() => setIsContactExpandedDesktop(false)}
                data-cursor-hover
              >
                {/* Button content container */}
                <div className="relative w-full h-full">
            ...
            {isLoading ? (
              ...
              projects.map((project, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="relative block transition-all duration-[900ms] ease-out cursor-pointer"
                      style={{
