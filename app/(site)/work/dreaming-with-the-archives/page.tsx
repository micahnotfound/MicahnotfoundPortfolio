...
export default function DreamingWithTheArchivesPage() {
  ...
  const heroImage1 = {
    public_id: "v1756779258/h2_cjjt1w",
    kind: "image" as const,
    alt: "Dreaming with the Archives header image 1"
  }

  const heroImage2 = {
    public_id: "v1756779255/h1_uotwpd",
    kind: "image" as const,
    alt: "Dreaming with the Archives header image 2"
  }

  const heroImage3 = {
    public_id: "v1756779251/h3_eyedug",
    kind: "image" as const,
    alt: "Dreaming with the Archives header image 3"
  }

  // Exhibition photos
  const exhibitionPhoto1 = {
    public_id: "v1756680389/Banners_0003_Layer_2_pt4aly",
    kind: "image" as const,
    alt: "DWA exhibition view 1"
  }

  const exhibitionPhoto2 = {
    public_id: "v1756680384/thumbnails_0000_Layer_7_abpzsq",
    kind: "image" as const,
    alt: "DWA exhibition view 2"
  }

  const exhibitionPhoto3 = {
    public_id: "v1756680384/Banners_0002_Layer_3_wsydzy",
    kind: "image" as const,
    alt: "DWA exhibition view 3"
  }

  // Video
  const videoPublicId = "v1756680438/DWA_Reel_oegaxm"

  // Project info
  const projectTitle = "Dreaming With The Archives"
  const projectDescription = "Produced by Kinfolk Tech, Dreaming with the Archives was a free public AR art exhibition that transformed Brooklyn Bridge Park into a digital monument to layered histories of Brooklyn and the African diaspora. Launched on Juneteenth 2025, the experience featured site-specific works by leading artists and marked the beginning of a year-long, multi-city initiative reimagining public space and collective memory through art and technology."
          ...
          >
            ...
            >
              <Media
                ...
                alt={heroImage1.alt || 'DWA Header 1'}
              />
            </div>
            ...
            >
              <Media
                media={heroImage2}
                className="w-full h-full object-cover"
                alt={heroImage2.alt || 'DWA Header 2'}
              />
            </div>
            ...
            >
              <Media
                media={heroImage3}
                className="w-full h-full object-cover"
                alt={heroImage3.alt || 'DWA Header 3'}
              />
            </div>
          </div>
