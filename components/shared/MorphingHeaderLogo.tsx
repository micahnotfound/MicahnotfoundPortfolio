...
export function MorphingHeaderLogo({ state, className = '', style, disableTransition = false }: MorphingHeaderLogoProps) {
  // STATE ZERO: Extra tall version - 20% taller than state 1 (~546px)
  // State 1 legs are 398.6, so 20% taller: 398.6 * 1.2 = 478.32, round to 478
  const stateZeroPath = "M56.62,56.07c.13-3.22,2.75-5.74,5.98-5.74s5.84,2.52,5.97,5.73l6.56,478h109.45l6.56-478c.14-3.21,2.76-5.73,5.97-5.73s5.84,2.52,5.97,5.74l6.25,477.99h109.46l6.57-478c.14-3.21,2.76-5.73,5.97-5.73s5.84,2.52,5.97,5.74l6.25,477.99h50.38l-6.33-480.02c-1.22-30.31-25.94-54.05-56.27-54.05s-54.98,23.69-56.26,53.93l-5.34,449.15h-11.26l-5.08-449.03c-1.22-30.31-25.94-54.05-56.27-54.05s-54.98,23.69-56.26,53.93l-5.34,449.15h-11.31l-5.34-449.15C117.58,23.69,92.87,0,62.6,0S7.55,23.74,6.33,54.05L0,534.07h50.38l6.25-477.99Z"
